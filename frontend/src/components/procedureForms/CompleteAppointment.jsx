...
const CompleteAppointment = ({ onClose, onSuccess }) => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            const res = await fetch('http://localhost:4000/api/completeAppointment', {
                method: 'POST',
            ...
            if (result.success) {
                ...
                onClose();
                onSuccess?.('Successfully completed the appointment!');
            } else {
    ...
    return (
        <div className='inputFormTemplate h-[50vh]'>
