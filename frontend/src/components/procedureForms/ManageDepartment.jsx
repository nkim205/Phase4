...
const ManageDepartment = ({ onClose, onSuccess }) => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            const res = await fetch('http://localhost:4000/api/manageDepartment', {
                method: 'POST',
            ...
            if (result.success) {
                ...
                onClose();
                onSuccess?.('Staff member assigned as manager to the department!');
            } else {
